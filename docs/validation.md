...
DocFence 0.52 is validated as a parser and reporting boundary, not as a Word
...
only, not field evaluation. Those limits are explicit in the 0.52 contract; see
