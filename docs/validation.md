...
DocFence 0.47 is validated as a parser and reporting boundary, not as a Word
...
only, not field evaluation. Those limits are explicit in the 0.47 contract; see
