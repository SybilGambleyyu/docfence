...
def _profile_markdown(document: dict[str, object]) -> str:
    ...
    lines.extend(
        _word_hyperlink_markup_section(document.get("word_hyperlink_markup", {}))
    )
    lines.extend(
        _word_drawing_hyperlink_section(document.get("word_drawing_hyperlinks", {}))
    )
    lines.extend(
        _word_drawing_visibility_section(document.get("word_drawing_visibility", {}))
    )
    lines.extend(
...
def _report_markdown(report: DiffReport) -> str:
    ...
    lines.extend(_word_drawing_visibility_comparison(before, after))
...
def _word_hyperlink_markup_section(value: object) -> list[str]:
    return _inventory_section("WordprocessingML hyperlink markup inventory", value)


def _word_drawing_hyperlink_section(value: object) -> list[str]:
    return _inventory_section("DrawingML hyperlink-action inventory", value)


def _word_drawing_visibility_section(value: object) -> list[str]:
    return _inventory_section("DrawingML nonvisual visibility inventory", value)
...
def _word_vml_image_hyperlink_section(value: object) -> list[str]:
    return _inventory_section("VML image-data hyperlink inventory", value)


def _word_vml_linked_ole_object_section(value: object) -> list[str]:
...
def _sensitivity_label_comparison(
    before: dict[str, object], after: dict[str, object]
) -> list[str]:
    return _inventory_comparison(
...
def _word_hyperlink_markup_comparison(
    before: dict[str, object], after: dict[str, object]
) -> list[str]:
    return _inventory_comparison(
        "WordprocessingML hyperlink markup inventory",
        before.get("word_hyperlink_markup", {}),
        after.get("word_hyperlink_markup", {}),
    )


def _word_drawing_hyperlink_comparison(
    before: dict[str, object], after: dict[str, object]
) -> list[str]:
    return _inventory_comparison(
...
def _word_drawing_visibility_comparison(
    before: dict[str, object], after: dict[str, object]
) -> list[str]:
    return _inventory_comparison(
        "DrawingML nonvisual visibility inventory",
        before.get("word_drawing_visibility", {}),
        after.get("word_drawing_visibility", {}),
    )
...
def _word_vml_hyperlink_comparison(
    before: dict[str, object], after: dict[str, object]
) -> list[str]:
    return _inventory_comparison(
...
def _word_vml_image_hyperlink_comparison(
    before: dict[str, object], after: dict[str, object]
) -> list[str]:
    return _inventory_comparison(
        "VML image-data hyperlink inventory",
        before.get("word_vml_image_hyperlinks", {}),
        after.get("word_vml_image_hyperlinks", {}),
    )


def _word_vml_linked_ole_object_comparison(
    before: dict[str, object], after: dict[str, object]
) -> list[str]:
    return _inventory_comparison(
...
def _save_forms_data_comparison(
    before: dict[str, object], after: dict[str, object]
) -> list[str]:
    return _inventory_comparison(
